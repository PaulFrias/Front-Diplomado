    ...
    <div class="row">
      <div class="col-md-6">
        <div class="jumbotron jumbotron-fluid" >
          <div class="container">
            <img src="../assets/logoPetShop.png" class="bg-image" />
            <div class="vision">
              <h1>Vision.</h1>
              <p>
        ...
        <div class="jumbotron jumbotron-fluid" >
          <div class="container">
            ...
            <div class="mision">
              <h1>Mision.</h1>
              <p>
                Ser una empresa moderna y sólida, líder en el país y con proyección internacional. Liderada por un equipo con acceso a la más alta calidad de capacitación y con una mirada colaborativa e inclusiva.              </p>
            </div>   
          </div> 
        </div>
      </div>
